...
if (!ferrn_save_json('leads.json',$leads)) { http_response_code(500); echo json_encode(['ok'=>false,'message'=>'Could not save your enquiry. Please email michael@ferrnagency.com.']); exit; }
